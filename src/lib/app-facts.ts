...
export function buildAppFacts(): string {
  return [
    ...
    "QUELLENPOLITIK: Neue Fälle kommen aus Apify-Intake oder manuell geprüften Quellen/Transkripten. YouTube-Links sind Quellen-URLs, kein behauptetes autonomes YouTube-Crawler-System. Öffentliche YouTube-Fälle brauchen ein verifiziertes Transkript des gesprochenen Worts; reine Beschreibungs-Treffer sind nicht öffentlich.",
    "DEBATTEN-FÄLLE: Die debate-Fälle sind kuratierte Rebuttal-Fälle aus einem öffentlichen Debatten-Video (Christian Wolf vs. Jan Leyk). Review-Ziel sind ausschließlich die Aussagen des Debattengegners, nicht Christian Wolf selbst. Sie sind bewusst als Debatten-Sonderfall gekennzeichnet, kein normaler Gegner-Claim.",
